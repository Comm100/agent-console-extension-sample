...
"");a=a.replace(/<img([^>]*)>/gi,function(a,b){var c=a="",e=/src="([^"]*)"/i.exec(b);b=/alt="([^"]*)"/i.exec(b);null!==e&&(a=e[1]);null!==b&&(c=b[1]);return"function"===typeof g?g(a,c):"[image] ( "+a+" )"});a=a.replace(/<\/img>/gi,'');if("linebreak"===l)a=a.replace(/<\/?ul[^>]*>|<\/?ol[^>]*>|<\/?li[^>]*>/gi,"\n");else if("indention"===l)for(;/<(o|u)l[^>]*>(.*)<\/\1l>/gi.test(a);)a=a.replace(/<(o|u)l([^>]*)>(((?!<(o|u)l[^>]*>)(?!<\/(o|u)l>).)*)<\/\1l>/gi,f());"linebreak"===h?a=a.replace(/<h([1-6])[^>]*>([^<]*)<\/h\1>/gi,"\n$2\n"):
